export class Card {
  ...
  export class CardForm {
    constructor(formSelector, templateSelector, popupId, section, handleCardClick) {
    ...
    _handleFormSubmit(event) {
      ...
      const newCard = new Card(nameInput, linkInput, this._templateSelector, this._handleCardClick);
